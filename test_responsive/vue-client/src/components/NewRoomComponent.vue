        ...
        <div v-if="state=== 'initGame'" class="container">
            ...
            <div >
                <div class="alldiv row">
                    ...
                    <div>
                        <div>
                        <input class="demo1" type="radio" v-model="game.nb_Players" id="twoPlayers" name="twoPlayers" :value="parseInt(2)" checked>
                        <label for="twoPlayers" > 2 joueurs </label>
                        </div>
                        <div>
                        <input class="demo1" type="radio" v-model="game.nb_Players" id="fourPlayers" name="fourPlayers" :value="parseInt(4)">
            ...
            <div class="alldiv row">
                ...
                <div>
                    <div >
                        <input class="demo1" type="radio" v-model="game.nb_Squares" id="septCells" name="septCells" :value="parseInt(7)" >
                        <label for="septCells"> 7 cellules </label>
                    </div>
                    <div >
                        <input class="demo1" type="radio" v-model="game.nb_Squares" id="nineCells" name="nineCells" :value="parseInt(9)">
                        <label for="nineCells"> 9 cellules </label>
                    </div >
                    <div >
                        <input class="demo1" type="radio" v-model="game.nb_Squares" id="elevenCells" name="elevenCells" :value="parseInt(11)" >
                         <label for="elevenCells"> 11 cellules </label>
                    </div>
                    <div>
                        <input class="demo1" type="radio" v-model="game.nb_Squares" id="treizeCells" name="treizeCells" :value="parseInt(13)">
